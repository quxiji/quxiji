    ...
    //🚩🚩展现版本
    if( tool_get_url() == "crm.pipacoding.com" || tool_get_url() =="crm.hetao101.com"|| tool_get_url() == "api.hetao101.com" || tool_get_url() == "api.pipacoding.com"){ document.title = `.` + document.title ; tool_yindao(`[城门 [github_071602]`);  }
